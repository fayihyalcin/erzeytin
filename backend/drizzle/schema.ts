...
export const orders = pgTable('orders', {
  ...
  bankTransferAccount: jsonb('bank_transfer_account').$type<Record<string, unknown>>(),
  bankTransferReceiptUrl: text('bank_transfer_receipt_url'),
  bankTransferReceiptOriginalName: text('bank_transfer_receipt_original_name'),
  bankTransferReceiptNote: text('bank_transfer_receipt_note'),
